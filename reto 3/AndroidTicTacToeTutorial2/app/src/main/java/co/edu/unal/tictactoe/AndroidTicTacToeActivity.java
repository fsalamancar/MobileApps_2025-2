...
public class AndroidTicTacToeActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.new_game) { startNewGame(); return true; }
        if (id == R.id.ai_difficulty) { showDialog(DIALOG_DIFFICULTY_ID); return true; }
        if (id == R.id.quit) { showDialog(DIALOG_QUIT_ID); return true; }
        if (id == R.id.about) { showDialog(DIALOG_ABOUT_ID); return true; }
        return false;
    }
